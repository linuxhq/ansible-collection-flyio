---
name: molecule
description: Run a role's Molecule scenario through Tox. Scenarios hit real Fly.io and require explicit authorization.
---

# molecule

Confirm the intended credentials and target organization with the user before creating resources,
...
- Scenarios provision **real Fly.io resources**, can incur cost, and require explicit user authorization.
